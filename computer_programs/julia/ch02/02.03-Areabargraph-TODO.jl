...
#
# ------------------------------------------------------------------------------
# 02.03 - Areabargraph-TODO
# Produce a bar graph where on each interval the area, rather than the height, of
# the bar is equal to the fraction of outcomes that fell in the corresponding interval
# ------------------------------------------------------------------------------
